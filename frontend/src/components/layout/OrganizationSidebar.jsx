...
const navItems = [
  ...
  {
    to: "/organization/examiners",
    icon: FaUserTie,
    label: "Examiners",
  },
  {
    to: "/organization/proctors",
    icon: FaUserShield,
    label: "Proctors",
  },
  {
    to: "/organization/active-exams",
    icon: FaFileAlt,
    label: "Active Exams",
  },
  {
    to: "/organization/upcoming-exams",
    icon: FaCalendarAlt,
  ...
  return (
    <aside className="w-60 shrink-0 min-h-screen flex flex-col justify-between py-5 px-3 sticky top-0 h-screen sidebar-bg">
      ...
      <div>
        ...
        >
          <div
            className="w-8 h-8 rounded-lg flex items-center justify-center text-blue-500"
            style={{
